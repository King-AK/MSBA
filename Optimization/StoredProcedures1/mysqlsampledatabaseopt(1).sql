CREATE DATABASE IF NOT EXISTS`classicmodelsopt`;
...
Revised by J. Bradley on 10/10/16 to change database name to classicmodelsopt
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`classicmodelsopt` /*!40100 DEFAULT CHARACTER SET latin1 */;

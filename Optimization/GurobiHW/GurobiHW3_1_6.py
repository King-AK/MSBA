...
# set up constraints
m.addConstr(3.0 * v1 + 2.0 * v2, GRB.LESS_EQUAL, 2400.0,"UnderwritingHours")
m.addConstr(0.0 * v1 + 1.0 * v2, GRB.LESS_EQUAL, 800.0,"AdminHours")
m.addConstr(2.0 * v1 + 0.0 * v2, GRB.LESS_EQUAL, 1200.0,"ClaimsHours")

# Set objective function
m.setObjective(5.0 * v1 + 2.0 * v2, GRB.MAXIMIZE)
